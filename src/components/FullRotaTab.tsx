    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="relative md:col-span-2">
          ...
          <input
            type="text"
            placeholder="Search by role title, short code, or period dates..."
            value={searchTerm}
            ...
            >
              ...
              <div className="block sm:hidden divide-y divide-slate-100 p-2">
                {period.assignments.map((assignment, idx) => {
                  ...
                  const phone = getRolePhone(assignment.roleCategory);

                  return (
                    <div key={idx} className="p-3 space-y-2 rounded-xl">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-slate-900">
                          {roleObj?.title || assignment.roleCategory}
                        </span>

                        <a
                          href={`tel:${phone.replace(/\s+/g, '')}`}
                          className="font-mono text-xs font-bold text-emerald-700 flex items-center gap-1 hover:underline"
                        >
                ...
                <table className="w-full text-left text-xs">
                  <thead className="bg-slate-50 text-slate-500 font-semibold border-b border-slate-200">
                    <tr>
                      ...
                      <th className="py-2.5 px-4">Shift Range</th>
